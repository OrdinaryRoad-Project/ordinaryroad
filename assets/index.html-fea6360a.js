import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as i,c,a as n,b as s,d as e,e as t}from"./app-20fab0ff.js";const o={},u=t('<h1 id="生产环境部署" tabindex="-1"><a class="header-anchor" href="#生产环境部署" aria-hidden="true">#</a> 生产环境部署</h1><h2 id="k3s" tabindex="-1"><a class="header-anchor" href="#k3s" aria-hidden="true">#</a> k3s</h2><h1 id="podman" tabindex="-1"><a class="header-anchor" href="#podman" aria-hidden="true">#</a> Podman</h1>',3),r={href:"https://blog.csdn.net/Kiritow/article/details/113854996",target:"_blank",rel:"noopener noreferrer"},d={href:"https://www.cnblogs.com/WarBlog/p/15469441.html",target:"_blank",rel:"noopener noreferrer"},k=t(`<h2 id="搭建镜像仓库" tabindex="-1"><a class="header-anchor" href="#搭建镜像仓库" aria-hidden="true">#</a> 搭建镜像仓库</h2><p>Docker官方的Docker Registry是一个基础版本的Docker镜像仓库，具备仓库管理的完整功能，但是没有图形化界面。</p><p>搭建方式比较简单，命令如下：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">podman</span> run <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
